module github.com/ahmetson/sample-service

go 1.20

replace (
	github.com/ahmetson/common-lib => D:/sds/common-lib
	github.com/ahmetson/service-lib => D:/sds/service-lib
)

require (
	github.com/ahmetson/common-lib v0.0.0-20230717140750-5e95e61d69c2
	github.com/ahmetson/service-lib v0.0.0-20230722134030-6ce048fdbc3d
)
